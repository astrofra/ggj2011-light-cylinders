...
function	DrawBillboardQuad(matrix, center, size, color = Vector(1, 1, 1), flag = MaterialRenderDefault)
{
	...
	RendererDrawTriangle(g_render, v0, v1, v2, color, flag)
	RendererDrawTriangle(g_render, v0, v2, v3, color, flag)
}
