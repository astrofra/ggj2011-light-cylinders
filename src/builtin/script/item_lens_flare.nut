...
*/
	...
	function	DrawPart(part, camera_m, origin, delta, scale_distance)
	{
		...
		DrawBillboardQuadTextured(camera_m, p, s, flare_texture, u[0], u[1], Vector(color.x, color.y, color.z, a), MaterialRenderAdd | MaterialRenderNoDepthTest | MaterialRenderNoDepthWrite)
	}
